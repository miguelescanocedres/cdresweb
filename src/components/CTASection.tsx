      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <a
            ...
            className="text-white font-semibold px-8 py-4 rounded-lg border border-white/10 hover:border-[#0066FF]/40 hover:bg-white/5 hover:scale-[1.02] transition-all text-sm inline-flex items-center gap-2 justify-center tracking-wide focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B12]"
          >
