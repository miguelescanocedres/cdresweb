...
export function ParticleTextEffect({
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    offscreenCtx.font = "bold 100px Space Grotesk, Arial"
  ...
  const animate = () => {
    ...
    ctx.fillStyle = "rgba(6, 11, 18, 0.1)"
  ...
  }, [words, canvasWidth, canvasHeight, maxParticles])
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full p-4">
      ...
      <div className="mt-6 text-center max-w-md">
        <p className="text-xs font-mono tracking-[0.3em] text-[#8892A4] uppercase">Click y arrastra para destruir partículas</p>
      </div>
    </div>
  )
}
