...
import { ParticleBuildText } from "@/components/ui/particle-build-text"
...
export function HeroSplash() {
  ...
  return (
    ...
    >
      ...
      >
        {/* CDRES INTEC logo — particle build effect */}
        <div className="flex flex-col items-center gap-4 w-full max-w-5xl">
          {/* CDRES particle animation — C white, DRES blue */}
          <ParticleBuildText
            text="CDRES"
            charColors={["#FFFFFF", "#0066FF", "#0066FF", "#0066FF", "#0066FF"]}
            fontSize={160}
            fontWeight={900}
            fontFamily="Space Grotesk, sans-serif"
            className="h-[clamp(80px,20vw,240px)]"
          />

          {/* INTEC sub-brand — appears after a short delay */}
          <motion.div
